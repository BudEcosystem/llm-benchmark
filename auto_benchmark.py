...
def run_benchmark(args, engine_config, run_config, extras=None, checkpoint=None, checkpoint_path=None):
    ...
    if args.run_benchmark:
        ...
        for engine_config in tqdm(engine_configs, desc="Running engine configs"):
            new_checkpoint = run_benchmark(
                args, engine_config, run_config, extras, new_checkpoint, new_ckpt_path
            )
